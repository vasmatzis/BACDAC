...
Inputs include read-depth and segmentation data, and ref/alt counts for common single nucleotide 
polymorphisms (SNPs). Calculates the "Heterozygosity Score" and produces the Constellation plot 
to visualize allele-specific copy-number as shown in publication:
...
A third reference file is available at https://zenodo.org/records/18436153
3. hetScore_dbSnp_20180418.tsv.gz
