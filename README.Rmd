...
The function `runBACDAC()` will run all steps sequentially. The example for `runBACDAC()` provides
full details for running this function. The example is available in the package help and also at
