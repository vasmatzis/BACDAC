...
This is a basic example to make sure you can load some example data and use one of the simple functions. 
A successful attempt will generate a linear genome plot:
