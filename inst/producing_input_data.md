...
chr1,chr2,…,chrX,chrY  
`hetScore_dbSnp_20180418.tsv.gz` is a file with a list of 33629538
common snp positions. Other such files are available from a variety of
sources.
...
“ref”, “alt”, “reffreq”, “altfreq”. For example: chr pos id ref alt
reffreq altfreq 1 11012 rs544419019 C G 0.9119 0.08806 1 11063
rs561109771 T G 0.997 0.002995 1 13110 rs540538026 G A 0.9732 0.02676 1
13116 rs62635286 T G 0.903 0.09704
...
paste -d',' <( zcat hetScore_dbSnp_20180418.tsv.gz | tail -n +7 | awk 'BEGIN {OFS=","};{print $1,$2,$4,$5 }') <(cat [pileupTempFile]) >> [pileupFinal]
```
