...
You need a file with snp positions. `hetScore_dbSnp_20180418.tsv.gz` is
our file with a list of 33629538 common snp positions. Other such files
are available from a variety of sources. Our file is available to
download at <https://zenodo.org/records/18436153>

The columns in `hetScore_dbSnp_20180418.tsv.gz` are: “chr”, “pos”, “id”,
“ref”, “alt”, “reffreq”, “altfreq”. To see the first 4 rows of data,
skipping the comments and header line:
...
pileup file and reformat them into a 4-column summary file. It
specifically identifies which count belongs to the “Reference” allele
and which belongs to the “Alternate” allele for every genomic position.
