\dontrun{
  ...
  # 1. generate heterozygosity score (hetScore) by bin and by chromosome arm,
  # 2. save to the output directory
  # 3. make a 3-panel plot, top panel is the segmentation data and the next two panels are the
