...
`hetScore_dbSnp_20180418.tsv.gz` is a file with a list of 33629538 common snp positions. Other such files are available from a variety of sources.
...
For example:
chr     pos     id      ref     alt     reffreq altfreq
